	...
	<div class="container-fluid">
		<div id="navbar" class="row">
			...
			<div class="col-10">
				...
				<li class="nav-item">
					<a class="nav-link" href="indexAdmin.php?action=11">Ajout</a>
			  	</li>
			  	<li class="nav-item">
					<a class="nav-link active" href="indexAdmin.php?action=12">Modification</a>
			  	</li>
			  	<li class="nav-item">
			...
			<div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
				...
				<form method="post" action="indexAdmin.php?action=15">
					<div class="form-group">
						<select name="pseudoUser" onchange="">
						<?php
					 ...
					 // requete de verif
						 $resultats = $bdd->prepare("select pseudo from user");
						 ...
						 {
						?>
						 <option value=" <?php echo $st['pseudo']; ?>"> <?php echo $st['pseudo']; ?></option>
						 <?php
						 }
						 ?>
						</select>
