	...
	<div class="container-fluid">
		<div id="navbar" class="row">
			...
			<div class="col-10">
				...
				<li class="nav-item">
			  	...
			  	<li class="nav-item">
					<a class="nav-link active" href="indexAdmin.php?action=3003">Modification</a>
			  	</li>
			  	<li class="nav-item">
		...
		<div id="main" class="row justify-content-around">
			<div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
				...
				<form method="post" action="indexAdmin.php?action=3006">
					...
					<button type="submit" class="btn btn-primary btn-raised">Modifier</button>
